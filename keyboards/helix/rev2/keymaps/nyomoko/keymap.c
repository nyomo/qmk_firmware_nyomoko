...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                      KC_H,    KC_J,    KC_K,    KC_L,    KC_JYEN, KC_ENT, \
      KC_LSFT,XXXXXXX,KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_SCLN, KC_QUOT, KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH , \
      KC_LCTRL,XXXXXXX,XXXXXXX ,XXXXXXX,  KC_LGUI,KC_SPC,KC_LALT,KC_HENK,XXXXXXX,KC_EQL,KC_LBRC,S(KC_RBRC),S(KC_BSLS),S(KC_RO)\
      ),
