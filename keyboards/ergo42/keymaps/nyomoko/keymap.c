...
[BASE] = KEYMAP( \
  ...
  MO(META),KC_LSFT  , KC_Z, KC_X, KC_C, KC_V   , KC_B  ,KC_N   , KC_N, KC_M,     KC_COMM,  KC_DOT,   KC_SLSH, KC_JYEN,\
...
[META] = KEYMAP( \
/*[*{}{}[}}}}}}[}}[*{}}}[}{*[*{}j*/
  _______, _______, S(KC_1), S(KC_2), S(KC_3), S(KC_4), S(KC_5), KC_RBRC, KC_DQT, S(KC_RBRC), S(KC_BSLS),KC_RBRC, S(KC_BSLS),S(KC_NUHS), \
